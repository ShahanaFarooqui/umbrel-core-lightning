...
export const ChannelsSVG = props => {
  return (
    <motion.svg
      ...
      animate='visible'
      >
      <motion.line variants={STAGERRED_SPRING_VARIANTS_1} custom={0} x1='0' x2='42' y1='5' y2='5' className='stroke-gray stroke-linecap-round stroke-width-5' />
      ...
      <motion.line variants={STAGERRED_SPRING_VARIANTS_1} custom={0} x1='0' x2='42' y1='16' y2='16' className='stroke-gray stroke-linecap-round stroke-width-5' />
      ...
      <motion.line variants={STAGERRED_SPRING_VARIANTS_1} custom={0} x1='0' x2='42' y1='27' y2='27' className='stroke-gray stroke-linecap-round stroke-width-5' />
      ...
      <motion.line variants={STAGERRED_SPRING_VARIANTS_1} custom={0} x1='0' x2='42' y1='38' y2='38' className='stroke-gray stroke-linecap-round stroke-width-5' />
